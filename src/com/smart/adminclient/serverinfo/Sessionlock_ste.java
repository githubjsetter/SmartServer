...
/*功能"系统信息查询"单表编辑Model*/
public class Sessionlock_ste extends CQueryStemodel{
	Category logger=Category.getInstance(Sessionlock_ste.class);
	public Sessionlock_ste(CFrame frame) throws HeadlessException {
		super(frame, "系统信息");
	}
	...
	@Override
	public void doQuery() {
		ClientRequest req=new ClientRequest("查询服务器锁库");
