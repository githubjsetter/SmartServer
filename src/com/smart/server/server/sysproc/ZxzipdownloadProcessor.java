 ...
 *
 */
public class ZxzipdownloadProcessor  extends RequestProcessorAdapter {
	static String COMMAND = "npclient:downloadzxzip";
	Category logger=Category.getInstance(ZxzipdownloadProcessor.class);
	...
	public int process(Userruninfo userinfo, ClientRequest req,
		...
		File targetfile=new File(classdir,"专项开发/"+opid+".zip");
		if(!targetfile.exists()){
			resp.addCommand(new StringCommand("-ERROR:找不到功能ID为"+opid+"的专项开发包"));
			return 0;
		}
