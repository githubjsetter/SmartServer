 ...
 * @deprecated
 */
public class CDetailFormWindow extends CSteFormWindow{
    public CDetailFormWindow(CFrame owner, Steform steform, ActionListener actionlistener, String title) throws HeadlessException {
        super(owner, steform, actionlistener, title);
    }

    protected CStetoolbar createToolbar() {
        return MdeControlFactory.createMdedtltoolbar(actionlistener);
    }
