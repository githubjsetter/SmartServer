 ...
 * 
 */
package com.inca.npclient.pinyin.format;

/**
 * Define the output format of Hanyu Pinyin tones
 * 
 * <p>
 * Chinese has four pitched tones and a "toneless" tone. They are called PÃ­ng(å¹?
 * flat), ShÇŽng(ä¸? rise), QÃ¹(åŽ? high drop), RÃ¹(å…? drop) and Qing(è½? toneless).
 * Usually, we use 1, 2, 3, 4 and 5 to represent them.
 * 
 * <p>
 * This class provides several options for output of Chinese tones, which are
 * listed below. For example, Chinese character 'æ‰?
 * 
 * <table>
 * <tr>
 * <th>Options</th>
