...
public class TRootpaneUI extends BasicRootPaneUI {
	...
	void installBorder(JRootPane root) {
		// Border bd=UIManager.getBorder("RootPane.frameBorder");
		Border bd = new SmallInternalFrameBorder();
		root.setBorder(bd);
		/*
		 * int style = root.getWindowDecorationStyle();
		 * 
		 * if (style == JRootPane.NONE) { LookAndFeel.uninstallBorder(root); }
	...
	private JComponent createTitlePane(JRootPane root) {
		titlepane = new TabbedTitlePane((TRootpane) root);
		titlepane.addTabindex("0","导航");
		titlepane.setActiveindex(0);
		return titlepane;
	...
	private static class MetalRootLayout implements LayoutManager2 {
		...
		public Dimension preferredLayoutSize(Container parent) {
			...
			if (root.getWindowDecorationStyle() != JRootPane.NONE
				...
				JComponent titlePane = ((TRootpaneUI) root.getUI())
						.getTitlePane();
				if (titlePane != null) {
		...
		public Dimension minimumLayoutSize(Container parent) {
			...
			if (root.getWindowDecorationStyle() != JRootPane.NONE
					&& (root.getUI() instanceof TRootpaneUI)) {
				JComponent titlePane = ((TRootpaneUI) root.getUI())
						.getTitlePane();
				if (titlePane != null) {
	...
	private TabbedTitlePane titlepane;
	...
	private class MouseInputHandler implements MouseInputListener {
		...
		public void mousePressed(MouseEvent ev) {
			titlepane.mousePressed(SwingUtilities.convertMouseEvent(root, ev,
					titlepane));
		...
		public void mouseReleased(MouseEvent ev) {
			titlepane.mouseReleased(SwingUtilities.convertMouseEvent(root, ev,
					titlepane));
		...
		public void mouseMoved(MouseEvent ev) {
			titlepane.mouseMoved(SwingUtilities.convertMouseEvent(root, ev,
					titlepane));
		...
		public void mouseDragged(MouseEvent ev) {
			if (titlepane.mouseDragged(SwingUtilities.convertMouseEvent(root,
					ev, titlepane)) != 0) {
				return;
			}
			Window w = (Window) ev.getSource();
		...
		public void mouseEntered(MouseEvent ev) {
			titlepane.mouseEntered(SwingUtilities.convertMouseEvent(root, ev,
					titlepane));
			Window w = (Window) ev.getSource();
		...
		public void mouseExited(MouseEvent ev) {
			titlepane.mouseExited(SwingUtilities.convertMouseEvent(root, ev,
					titlepane));
			Window w = (Window) ev.getSource();
			w.setCursor(lastCursor);
		}
		...
		public void mouseClicked(MouseEvent ev) {
			Category logger=Category.getInstance(TRootpaneUI.class);
			logger.debug("mouseClicked");
			
			int ret=titlepane.mouseClicked(SwingUtilities.convertMouseEvent(root, ev,
					titlepane));
			if(ret!=0){
				return;
			}
	 ...
	 * 
	 */
	static class SmallInternalFrameBorder extends AbstractBorder implements
			UIResource {
		...
		static Color bordercolor = new Color(74, 140, 218);
