...
public class Printplandownload_dbprocess     extends RequestProcessorAdapter {
	static String COMMAND = "npclient:下载打印方案";
	static String COMMAND1 = "npclient:列出打印方案";
	...
	public int process(Userruninfo userinfo, ClientRequest req,
		...
		if(!targetfile.exists()){
			resp.addCommand(new StringCommand("-ERROR:找不到打印方案文件"+planfilename));
			return 0;
		}
	...
	void listPrintplan(Userruninfo userinfo, ClientRequest req,
		...
		File classdir=CurrentappHelper.getClassesdir();
		File dir=new File(classdir,"打印方案");
