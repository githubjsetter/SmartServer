...
public class JFontChooser extends JComponent
{
	...
	private static final Font DEFAULT_SELECTED_FONT = new Font("宋体", Font.PLAIN, 12);
...
*/	
	...
	protected JDialog createDialog(Component parent)
	{
		...
		JDialog dialog = new JDialog(frame, "选择字体", true);
	...
	protected JTextField getSampleTextField()
	{
		if (sampleText == null)
		{
			...
			sampleText = new JTextField("这是示例文本123ABC");
	...
	public static void main(String[] args) {
		    JFontChooser fontChooser = new JFontChooser();
		    int result = fontChooser.showDialog((Frame)null);
		    if (result == JFontChooser.OK_OPTION)
		    {
		    	Font font = fontChooser.getSelectedFont(); 
		    	System.out.println("Selected Font : " + font); 
