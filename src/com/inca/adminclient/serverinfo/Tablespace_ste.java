...
/*功能"系统信息查询"单表编辑Model*/
public class Tablespace_ste extends CQueryStemodel{
	Category logger=Category.getInstance(Tablespace_ste.class);
	public Tablespace_ste(CFrame frame) throws HeadlessException {
		super(frame, "系统信息");
	}
	...
	@Override
	public void doQuery() {
		ClientRequest req=new ClientRequest("查询表空间");
