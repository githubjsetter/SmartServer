...
/*功能"系统信息查询"单表编辑Model*/
public class Sqlmonitor_ste extends CQueryStemodel{
	Category logger=Category.getInstance(Listlogin_ste.class);
	public Sqlmonitor_ste(CFrame frame) throws HeadlessException {
		super(frame, "查询服务器执行情况");
	}
	...
	@Override
	public void doQuery() {
		ClientRequest req=new ClientRequest("查询服务器sql执行情况");
